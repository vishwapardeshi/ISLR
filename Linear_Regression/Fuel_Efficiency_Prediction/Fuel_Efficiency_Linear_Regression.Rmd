...
6. Multi collinearity: When VIF values lies in 5 - 10 range, a problematic amount of collinearity si presented. This was evident from the correlation plot too.  The problem of collinearity is that it reduces the accuracy of the estimates of the regression coefficients and it causes the standard error to increase.
